...
In August 2018, MDI Biological Laboratory received a 5-year NIH-NIGMS Science Education Partnership Award (SEPA) to create and pilot a national model of STEM (Science, Technology, Engineering, and Math) education. The project, "Data to Action: A Secondary School-Based Citizen Science Project to Address Arsenic Contamination of Well Water" will engage students as citizen scientists and provide them with the tools and skills to make sense of data so that their results can lead to change in their communities.
